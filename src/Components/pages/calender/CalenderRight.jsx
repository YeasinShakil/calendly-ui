...
const CalenderRight = () => {
    return (
        <div className='p-6 flex flex-col'>
            ...
            <p className='mt-10 font-medium text-gray-400 text-center md:text-left '>Bitbytesoft Oy</p>
            <h3 className='mt-3 text-2xl font-medium text-center md:text-left '>30 Minute Meeting</h3>
            <div className='mt-8 flex items-center text-gray-400'>
                <AiFillClockCircle />
                <p className=' ml-2 font-medium'>30 min</p>
            </div>
            <div className='cursor-pointer absolute bottom-4 text-center right-50'>
